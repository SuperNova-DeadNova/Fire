...
namespace Flames
{
    ...
    public struct Position : IEquatable<Position>
    {
        ...
        public Vec3F32 ToVec3F32() 
        {
            return new Vec3F32(X / 32.0f, Y / 32.0f, Z / 32.0f); 
        }
        ...
        { 
            return new Position(x, y + Entities.CharacterHeight, z); 
        }
    ...
    public struct Orientation
    {
        ...
        public static Orientation Unpack(uint raw)
        {
            ...
            rot.RotX = (byte)raw; 
            rot.RotY = (byte)(raw >> 8);
            rot.RotZ = (byte)(raw >> 16); 
            rot.HeadX = (byte)(raw >> 24);
            return rot;
        }
    }
}