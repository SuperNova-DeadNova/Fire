...
namespace Flames.Config
{
    public class ConfigColorAttribute : ConfigAttribute
    {
        ...
        public ConfigColorAttribute(string name, string section, string def) : base(name, section) 
        { 
            defCol = def; 
        }
    ...
    public class ConfigStringAttribute : ConfigAttribute
    {
        ...
        public ConfigStringAttribute(string name, string section, string def, 
            bool empty, string allowed) : base(name, section) 
        { 
            defValue = def; 
            allowEmpty = empty; 
        ...
        public ConfigStringAttribute(string name, string section, string def, 
            bool empty) : base(name, section) 
        { 
            defValue = def; 
            allowEmpty = empty; 
        }

        public ConfigStringAttribute(string name, string section, string def) : base(name, section) 
        { 
            defValue = def; 
        }

        public ConfigStringAttribute() : base(null, null) 
        { 
            allowEmpty = true; 
        }
