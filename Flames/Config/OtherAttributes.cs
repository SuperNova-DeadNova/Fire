...
namespace Flames.Config
{
    ...
    public class ConfigBoolAttribute : ConfigAttribute
    {
        ...
        public ConfigBoolAttribute(string name, string section, bool def) : base(name, section) 
        { 
            defValue = def; 
        }
    ...
    public class ConfigPermAttribute : ConfigAttribute
    {
        ...
        public ConfigPermAttribute(string name, string section, LevelPermission def) : base(name, section) 
        { 
            defPerm = def; 
        }
    ...
    public class ConfigEnumAttribute : ConfigAttribute
    {
        ...
        public ConfigEnumAttribute(string name, string section, object def, Type type) : base(name, section) 
        { 
            defValue = def; 
            enumType = type; 
        }
    ...
    public class ConfigBoolArrayAttribute : ConfigAttribute
    {
        ...
        public ConfigBoolArrayAttribute(string name, string section, bool def, int min) : base(name, section) 
        { 
            defValue = def; 
            minCount = min; 
        }
